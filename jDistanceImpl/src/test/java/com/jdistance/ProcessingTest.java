...
public class ProcessingTest {
    ...
    public void testConstantResultClassifier() {
        GraphBundle bundle = new GraphBundle(ParseInput.parse("./dataForGenerator/defaultParameters.txt"), 2);
    ...
    public void testBestClassifierResultNotNull() {
        GraphBundle bundle = new GraphBundle(ParseInput.parse("./dataForGenerator/defaultParameters.txt"), 5);
        Checker checker = new ClassifierChecker(bundle, 4, 0.3);
