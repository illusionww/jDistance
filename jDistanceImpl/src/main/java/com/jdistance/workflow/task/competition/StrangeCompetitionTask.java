...
public class StrangeCompetitionTask {
    ...
    public StrangeCompetitionTask(MetricChecker checker, Integer pointsCount, Integer n, Double pIn, Double pOut, Integer countForCompetition, Integer k, String fileName) {
