...
public class GeneratorPropertiesPOJO {
    ...
    public GeneratorPropertiesPOJO(int graphsCount, int nodesCount, int clustersCount, double p_in, double p_out) {
    ...
    public GeneratorPropertiesPOJO(int graphsCount, int[] sizeOfClusters, double[][] probabilityMatrix) {
        this.graphsCount = graphsCount;
