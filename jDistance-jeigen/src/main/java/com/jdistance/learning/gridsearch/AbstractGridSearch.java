...
public abstract class AbstractGridSearch implements Serializable {
    ...
    public AbstractGridSearch(String name, Estimator estimator, AbstractMeasureWrapper metricWrapper, Scorer scorer, double from, double to, int pointsCount) {
        this(name, estimator, metricWrapper, scorer, linspace(from, to, pointsCount));
    }

    public AbstractGridSearch(String name, Estimator estimator, AbstractMeasureWrapper metricWrapper, Scorer scorer, List<Double> paramGrid) {
        this.name = name;
    ...
    public abstract void predict(GraphBundle graphs);

    protected Double score(Double idx, AbstractMeasureWrapper metricWrapper) {
