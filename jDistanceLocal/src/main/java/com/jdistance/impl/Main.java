...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class clazz = Class.forName("com.jdistance.impl.Main");
    ...
    public void rejectCurves() {
        ...
        rejectCurve(graphs, Distance.P_WALK, 0.8261);
        rejectCurve(graphs, Distance.WALK, 0.7174);
        rejectCurve(graphs, Distance.FOR, 0.8913);
        rejectCurve(graphs, Distance.LOG_FOR, 0.3478);
        rejectCurve(graphs, Distance.COMM, 0.1739);
        rejectCurve(graphs, Distance.LOG_COMM, 0.4565);
        rejectCurve(graphs, Distance.HEAT, 0.4348);
        rejectCurve(graphs, Distance.LOG_HEAT, 0.4783);
        rejectCurve(graphs, Distance.RSP, 0.9783);
        rejectCurve(graphs, Distance.FE, 0.9130);
        rejectCurve(graphs, Distance.SP_CT, 0.9891);
    }
